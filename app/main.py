...
from app.schemas import BaseMenu
...
@app.get("/api/v1/menus", response_model=list[BaseMenu])
...
@app.get("/api/v1/menus/{menu_id}", response_model=BaseMenu)
def get_menu(menu_id: int, db: Session = Depends(get_db)):
    """Get one menu"""
    return crud.get_menu(db, menu_id)
